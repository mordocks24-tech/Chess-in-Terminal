...
A functional chess engine that runs in your command line for Windows. (No Castleing or en passant. Yet!)
...
1. Clone the repository:
   `git clone https://github.com/mordocks24-tech/Chess-in-Terminal`
